...
class SynDetectModel(object):
    def __init__(self):
        ...
        self.model.summary()
        self.model_checkpoint = ModelCheckpoint('exclude/syn_best_model.h5', monitor='val_loss', mode='min', save_best_only=True)
...
class LocDetectModel(object):
    def __init__(self):
        ...
        self.model.summary()
        self.model_checkpoint = ModelCheckpoint('exclude/loc_best_model.h5', monitor='val_loss', mode='min', save_best_only=True)
